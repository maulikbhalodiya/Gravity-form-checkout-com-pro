...
1. Upload plugin to `/wp-content/plugins/gravityforms-checkout-com-pro/`
2. Activate the plugin
3. Configure API keys in Forms > Settings > Checkout.com Pro
4. Create form feeds with Checkout.com Pro payment method
